...
const Route$6 = createRootRoute({ shellComponent: RootDocument });
...
async function loadBenchmarkData(delayMs) {
  await new Promise((resolve) => setTimeout(resolve, delayMs));
  return createBenchmarkData();
}
function BenchmarkPage({ data, scenario }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { "data-benchmark-ready": scenario, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { children: [
      "Framework benchmark: ",
      scenario
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { "data-generated-at": data.generatedAt, children: [
      data.items.length,
      " deterministic items"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { children: data.items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { "data-item": item.id, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: item.label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("progress", { max: 100, value: item.score }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: item.score })
    ] }, item.id)) })
  ] });
}
const $$splitComponentImporter$4 = () => import("./streaming-DNsMIc_B.js");
const Route$5 = createFileRoute("/streaming")({
  loader: () => ({
    data: loadBenchmarkData(200)
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./isr-3QcJRSrK.js");
const Route$4 = createFileRoute("/isr")({
  loader: () => loadBenchmarkData(50),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./dynamic-B5OVdSnG.js");
const Route$3 = createFileRoute("/dynamic")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./index-BOEO2Rta.js");
const Route$2 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-g99J11ZS.js");
const Route$1 = createFileRoute("/loader/")({
  loader: () => loadBenchmarkData(50),
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const BENCHMARK_NONCE = "1789501643188-1-tanstack";
const Route2 = createFileRoute("/api/ping")({ server: { handlers: { GET: () => json({ framework: "tanstack-start", nonce: BENCHMARK_NONCE }, { headers: { "cache-control": "private, no-store" } }) } } });
const StreamingRoute = Route$5.update({
  id: "/streaming",
  path: "/streaming",
  getParentRoute: () => Route$6
});
const IsrRoute = Route$4.update({
  id: "/isr",
  path: "/isr",
  getParentRoute: () => Route$6
});
const DynamicRoute = Route$3.update({
  id: "/dynamic",
  path: "/dynamic",
  getParentRoute: () => Route$6
});
...
const LoaderIndexRoute = Route$1.update({
  id: "/loader/",
  path: "/loader/",
  getParentRoute: () => Route$6
});
const ApiPingRoute = Route2.update({
  id: "/api/ping",
  path: "/api/ping",
  getParentRoute: () => Route$6
});
...
export {
  ...
  Route$5 as R,
  Route$4 as a,
  BENCHMARK_NONCE as b,
  createBenchmarkData as c,
  Route$1 as d,
  router as r
};
